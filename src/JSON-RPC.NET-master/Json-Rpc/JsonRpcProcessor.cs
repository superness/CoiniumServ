            ...
            JsonSerializerSettings settings = null)
        {
            ...
            for (var i = 0; i < batch.Length; i++)
            {
                ...
                if (singleBatch && (jsonResponse.Id != null || jsonResponse.Error != null))
                {
                    ...
                    //    writer.WriteValue(jsonResponse.JsonRpc);
                    //}
                    //if (jsonResponse.Error != null)
                    //{
                        writer.WritePropertyName("error"); 
                        writer.WriteRawValue(JsonConvert.SerializeObject(jsonResponse.Error, settings));
                    //}
                    //else
                    //{
                        writer.WritePropertyName("result"); 
                        writer.WriteRawValue(JsonConvert.SerializeObject(jsonResponse.Result, settings));
                    //}
